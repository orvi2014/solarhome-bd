  ...
  <section id="portfolio">
    <div class="ed-container">
        <div class="section-title">
            <h2 class="portfolio-sec wow fadeIn" data-wow-duration="6s">ZRST-270P-60</h2>
        </div>
    <div class="portfolio-wrap clear wow fadeInUp product" data-wow-duration="2s">
      <img src="images\ZRSolar.jpg" alt = 'ZRST-270P-60' />
    </div>
    ...
    <div class="tbl-content">
      ...
      <h2>To download details click <a href="pdf/zr/ZRST-270P-60.pdf" target="_blank">here</a></h2>
    </div>
