  ...
  <section id="portfolio">
    <div class="ed-container">
        <div class="section-title">
            <h2 class="portfolio-sec wow fadeIn" data-wow-duration="6s">SL-40P</h2>
        </div>
    <div class="portfolio-wrap clear wow fadeInUp product" data-wow-duration="2s">
      <img src="images\SolarLight.jpg" alt = 'Solar Light' />
    </div>
    ...
    <div class="tbl-content">
      ...
      <h2>To download details click <a href="pdf/solar/SL-40P.pdf" target="_blank">here</a></h2>
    </div>
